...
FM_SNAPSHOT_RUNS_TIMEOUT=5         # seconds bounding the shared per-cycle no-mistakes runs-inventory call; on expiry the cycle falls back to live per-task reads rather than a stale fingerprint
